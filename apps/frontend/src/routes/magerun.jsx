...
class Magerun extends React.Component {
  ...
  drawChar() {
    ...
    this.ctx.strokeRect(
      ...
      this.offset + this.player.y * this.tileSize,
      this.tileSize,
      this.tileSize
    );
  }
  ...
  drawDesination() {
    if (this.destinationOnTick) {
      if (
        this.player.x !== this.destinationOnTick.x ||
        this.player.y !== this.destinationOnTick.y
      ) {
        this.ctx.strokeStyle = '#FFFF00';
        this.ctx.strokeRect(
          this.destinationOnTick.x * this.tileSize,
          this.offset + this.destinationOnTick.y * this.tileSize,
          this.tileSize,
          this.tileSize
        );
      }
      ...
      if (this.player.x !== this.destination.x || this.player.y !== this.destination.y) {
        ...
        this.ctx.strokeRect(
          ...
          this.offset + this.destination.y * this.tileSize,
          this.tileSize,
          this.tileSize
        );
      }
  ...
  playerCords() {
    return {
      ...
      y: this.offset + this.player.y * this.tileSize + this.tileSize / 2,
    };
  }
    ...
    return (
      <div id="background">
        <div className="parent">
          <img
            className={`olm ${this.state.headDirection} child`}
            src={assetUrl('olm.jpg')}
            height={this.offset - 20}
          />
...
function approachTarget(object, target) {
  ...
  ratiox = ratiox < 1 ? 0.33 : ratiox;
  ratioy = ratioy < 1 ? 0.33 : ratioy;
