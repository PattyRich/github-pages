    ...
    return (
      <div className="route-dark-bg">
        ...
        >
              ...
              <div key={index1} style={{ display: 'flex' }}>
                {row.map((tile, index2) => {
                  return (
                    ...
                    >
                      {this.state.hintTile[0][0] === index1 &&
                        this.state.hintTile[0][1] === index2 && (
                          <div
                            className="toa-hint"
                            style={{
                              ...box,
          ...
          <button style={{ margin: '5px' }} onClick={this.resetBoard}>
            {' '}
            Reset (r){' '}
          </button>
          <button style={{ margin: '5px' }} onClick={this.shuffle}>
            {' '}
            Shuffle (s){' '}
          </button>
          <button style={{ margin: '5px' }} onClick={this.hint}>
            {' '}
            Hint (h){' '}
          </button>
